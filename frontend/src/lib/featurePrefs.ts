// 功能开关类的本机偏好（存 localStorage）：口播生成完自动套用（HIG-56）、大字报粘贴按标点分行及标点处理（HIG-55）。
...
export const FEATURE_DEFAULTS: FeaturePrefs = { autoApplyDub: true, posterSplitOnPaste: true, posterPunct: 'keep' };
