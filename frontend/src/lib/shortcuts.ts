...
export const SHORTCUTS: Shortcut[] = [
  ...
  { id: 'seek-start', keys: ['Home'], label: '跳到开头', group: '全局' },
  { id: 'seek-end', keys: ['End'], label: '跳到结尾', group: '全局' },
  ...
  { id: 'delete-range', keys: ['Delete'], label: '删除选中区间 / 选中的主轨片段', group: '剪辑', steps: TRIM },
  { id: 'split-main', keys: ['⌘', 'B'], label: '在播放头分割主轨 / 拆分所选视频片段', group: '剪辑', steps: TRIM },
  // 音频
  ...
  { id: 'split-layer', keys: ['S'], label: '在播放头处拆分选中图层', group: '图层', steps: LAYER_STEPS },
  { id: 'split-layer-cmd', keys: ['⌘', 'B'], label: '拆分选中图层（剪映键位）', group: '图层', steps: LAYER_STEPS },
  { id: 'bar-drag', keys: ['拖动'], label: '拖动图层条移动时段 / 拖两端调整（全程条拖两端即收成具体时段）', group: '图层', steps: LAYER_STEPS },
  ...
  { id: 'snap', keys: ['N'], label: '吸附开关（含播放头吸附剪辑点）', group: '时间轴' },
  { id: 'tl-select-all', keys: ['⌘', 'A'], label: '全选时间线片段', group: '时间轴' },
  { id: 'group', keys: ['⌘', 'G'], label: '组合所选片段（未选时一键复合）', group: '时间轴' },
  { id: 'ungroup', keys: ['⇧', '⌘', 'G'], label: '解除组合', group: '时间轴' },
  { id: 'group-pick-one', keys: ['⌥', '点击'], label: '只选组合里的单个片段', group: '时间轴' },
